...
public class EXE {
    ...
    public void action(boolean mode) {
        ...
        if(alucu_func == "1110" || alucu_func == "1111"){
            data1 = getIdexe().getRT_DATA();
            String Shift_amount = getIdexe().getSignExt().substring(21,26);
            data2 = (byte)Long.parseLong(Shift_amount, 2);
            getExemem().setALU_result(alu(data1,data2,alucu_func));
        }
        ...
        //have a Load or something, Otherwise it's R-Type and or branch.]
            ...
            data1 = getIdexe().getRS_DATA();
            data2 = ALU_Src?(int)Long.parseLong(getIdexe().getSignExt(), 2):getIdexe().getRT_DATA();
            getExemem().setALU_result(alu(data1,data2,alucu_func));
        }
        ...
        getExemem().setRT_DATA(Integer.toBinaryString(getIdexe().getRT_DATA()));
