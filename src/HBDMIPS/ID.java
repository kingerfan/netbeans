...
public class ID{
	...
	/**
	 * Do the job of InstructionDecode stage.
	 * This includes:
...
//		}
		...
		int forthPart = Integer.parseInt(instruction.substring(21, 26), 2);
		System.out.println("id action forth port: "+forthPart);
